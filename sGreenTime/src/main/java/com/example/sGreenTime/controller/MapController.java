...
public class MapController {
    ...
    public ModelAndView vworldData(@RequestParam(required = false) String swLatLng,
        ...
        hikingApiUrl1 = "https://api.vworld.kr/req/data?service=data&request=GetFeature&data=LT_L_FRSTCLIMB&key=D24E3DA9-245A-3E4A-A680-6A704EA8A93A&geomfilter=BOX(127,37.5,127.3,37.6)";
        ...
        String hikingApiBaseUrl2 = "&key=D24E3DA9-245A-3E4A-A680-6A704EA8A93A&geomfilter=BOX(127,37.5,127.3,37.6)";
